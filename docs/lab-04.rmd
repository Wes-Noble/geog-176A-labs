...
Of the tessellations, the voroni tessellation closely matched the original conus counties well while simplifying points. I thought the grid and hexagonal coverage to be good uses for say population estimates in regional point-in-polygon research because of the size of their smaller polygons, but not for county or state level comparisons. It might just be that the triangulation tessellation has a lot going on in it, but I can't really render a good use for it with my spatial knowledge yet.
...
Because of the difference in the area feature of our polygons between the created coverages and tessellations, point in polygon amount and distribution are represented differently. The voroni tessellation does a good job matching the original county distribution of dam points in the county polygons, while the grid coverage represents more polygons with fewer interior points because of their smaller area feature. This relates to the MAUP problem because it shows how spatial rendering of districts or simply polygons can influence and mutate statistical analysis in point-based research. As we move on with this lab, I will use the voroni tessellation because I think it well represents what could be the watershed of a given river or river system that can be influenced by dams as well as closely match the original county plot.
...
I think the flood control plot is really interesting because it highlights where dams may in places along the Mississippi River to prevent flooding, which makes a lot of sense due to the river's large geographic extent. The distribution of hydroelectric dams was a little odd to me. I don't really know why so many of them are clumped to the far Northeast and West Coast. In addition, the fact that most damns in the US are not hydroelectric confuses me because I would assume most dams should be utilizing such technology as a source of income and power for the US. Also, being that dams are a major burden to natural fish migration and spawning in the NW, with the removal of dams in the PNW in order to revive stream ecology, will such regions and states begin to result back to fossil fuels or move to other renewable energy sources?
